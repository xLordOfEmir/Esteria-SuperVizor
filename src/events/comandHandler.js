...
const iltifatlar = [
    ...
    'Emirhana cıkma teklifi eder misin ?',
    'İğrenç İnsansın!',
...
module.exports = async (message) => {
    if (!message.guild || message.author.bot) return
      const owner = client.users.cache.get("923159255031373855");
    ...
    if (message.channel.id === config.channels.chat) {
      ...
      const ownerr = client.users.cache.get("923159255031373855");
